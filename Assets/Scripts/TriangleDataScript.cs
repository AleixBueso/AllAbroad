...
namespace BoatTutorial
{
    ...
    public struct TriangleDataScript
    {
        ...
        public TriangleDataScript(Vector3 p1, Vector3 p2, Vector3 p3)
        {
            this.p1 = p1;
            this.p2 = p2;
            this.p3 = p3;
            ...
            this.distanceToSurface = Mathf.Abs(WaterControllerScript.current.DistanceToWater(this.center, Time.time));
