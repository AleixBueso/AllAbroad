...
namespace BoatTutorial
{
    public class BoatPhysicsScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            modifyBoatMesh = new ModifyBoatMeshScript(gameObject);
        ...
        {
            //Get all triangles
            List<TriangleDataScript> underWaterTriangleData = modifyBoatMesh.underWaterTriangleData;

            for (int i = 0; i < underWaterTriangleData.Count; i++)
            {
                //This triangle
                TriangleDataScript triangleData = underWaterTriangleData[i];
        ...
        private Vector3 BuoyancyForce(float rho, TriangleDataScript triangleData)
        {
