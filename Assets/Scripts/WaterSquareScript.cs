...
public class WaterSquareScript
{
    ...
    public WaterSquareScript(GameObject waterSquareObj, float size, float spacing)
    {
    ...
    public void MoveSea(Vector3 oceanPos, float timeSinceStart)
    {
        ...
        for (int i = 0; i < vertices.Length; i++)
        {
            ...
            vertex.y = WaterControllerScript.current.GetWaveYPos(vertexGlobal, timeSinceStart);
